...
{
    public class ClipWindowViewModel : BaseViewModel
    {
        ...
        public ClipWindowViewModel(Company __Company, Series __Series, Paging __ClipPaging,int __ClipHasVideo, Clip __Clip)
        {
